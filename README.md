...
6. Configure your hosts file: 127.0.0.1 magento24.local 
   1. In windows:-  c:\Windows\System32\Drivers\etc\hosts.
   2. Mac/Ubuntu:-  /etc/hosts

7. Open http://magento24.local/ 

8. Open http://magento24.local/admin/
...
# 10. To Setup Muiltiple Website:
 ...
 10.2) Modify nginx config file in docker(docker/nginx/default.conf): <br />
         ...
         upstream fastcgi_backend {
          ...
          server {
              listen 80;
              server_name magento24.local magento24-second.local;
  ...
  10.3). Configure your hosts file: 127.0.0.1 magento24.local magento24-second.local <br />
